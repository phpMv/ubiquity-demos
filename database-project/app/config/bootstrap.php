...
function _dev($devtools,$config){
	...
	\Ubiquity\contents\transformation\TransformersManager::start();
	\Ubiquity\contents\transformation\TransformersManager::registerClassAndSave('uuid',\services\transformers\UUIDTransformer::class);
